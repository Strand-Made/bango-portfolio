const projects = [
  ...
  },
  {
    ...
    desc: `I created this website for a imaginary museum for school children between the ages of 7-15.
          ...
          Since its core audience is children, I decided to use color to make the website more appealing for children.`,
    client: "School project",
    tools: `<i class="fab fa-html5" alt="HTML"></i>
       <i class="fab fa-css3-alt" alt="CSS"></i>
       <i class="fab fa-js" alt="JS"></i>`,
    ...
    aboutLink: "interactive-museum.html",
  ...
  },
  {
    ...
    tools: `<i class="fab fa-html5" alt="HTML"></i>
       <i class="fab fa-css3-alt" alt="CSS"></i>
      <i class="fab fa-js" alt="JS"></i>
       <i class="fab fa-sass" alt="Sass"></i>`,
  ...
  },
  {
    ...
    desc: `<p>Letha is a organic leather shoe retailer aimed at men from age 21-40. Letha wants to offer their customers shoes for every occasion.
    The website uses a different range of persuasive techniques to drive users to interaction.</p>
  
    <p>The website was designed on xD after having researched and perfomed a card-sorting method for organizing the userflow.
    Letha uses minimal color since the main goal of the site is to sell products, and therefore giving the product the opportunity to take priority in the design does just that.</p>
    `,
    client: "School project",
    tools: `<i class="fab fa-html5" alt="HTML"></i>
      <i class="fab fa-css3-alt" alt="CSS"></i>`,
...
//Future project update (needs redesign)
// {
//   name: "Recycle",
//   desc: `Recycle is a company which offers eco-friendly guided tours of a town.
//       Since their clients will be travelling it was important that their website is mobile responsive.
//       The website uses images of the nature since its the experience the client is selling.
//       The website itself is very simple to not have any distractions take away the focus form the nature images `,
//   client: "School project",
//   tools: `<i class="fab fa-css3-alt"></i>
//      <i class="fab fa-js"></i>
//      <i class="fab fa-html5"></i>`,

//   image: "http://www.bango.one/portfolio/recycle-preview.png",
